    ...
    return (
        <main className="flex flex-col min-h-screen items-center justify-center p-4">
            <h1 className="text-5xl font-bold mb-8">
                <span className="text-primary">HYPERLIQUID</span> Balances</h1>
                    ...
                    data.map((wallet: any) => (
                        <Card key={wallet.address} className="">
                            <CardHeader>
                                ...
                                <CardDescription>Wallet Balance: <span className="text-primary">${parseFloat(wallet.portfolio).toFixed(2)}</span> USD</CardDescription>
